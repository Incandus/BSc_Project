...
module Simulation_data
  ...
  real, save :: sim_TAmbient, sim_rhoAmbient, sim_pResev
  real, save :: sim_gamma, sim_smallP, sim_smallX, sim_pAmbient
  real, save :: eos_singlespeciesa, eos_singlespeciesz
  real, save :: sim_dcrit, sim_dexit, sim_lopt, sim_angle, sim_obslen
